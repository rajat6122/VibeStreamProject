...
const Login = () => {
  ...
  const [showContactForm, setShowContactForm] = useState(false); // State for toggling ContactForm
  ...
  const handlesubmit = (e) => {
    ...
    if (email === "") {
      ...
      signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
          // Successfully signed in, store the user's ID token in local storage
  ...
  return (
    <div>
      ...
      {/* Show ContactForm if state is true */}
      ...
      <div className="flex flex-col items-center">
        <button
          ...
          onClick={() => signInWithGoogle().then(() => navigate("/main"))}
        >
          <img
        ...
        <button
          ...
          onClick={() => signInWithGithub().then(() => navigate("/main"))}
        >
          <img
